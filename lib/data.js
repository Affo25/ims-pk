...
export const sources = ["Intercom", "Mass Email", "Website", "Social media", "Google", "Referral", "Call", "Existing"];

export const fishs = ["Big", "Small"];
...
export const solutions = [
  ...
  "Dart vending machine",
  "Mirrorbooth",
  "Giftbox",
  "PartyBox Original",
  "PartyBox 360",
  "PartyBox 120 slider",
  "PartyBox mirrorbooth",
];

export const extras = ["AI", "Greenscreen", "Prints", "Prints + station", "Lights"];
export const contactStatus = ["Hot", "Cold", "Lost"];

export const names = ["iboothme", "iboothme team", "PartyBox", "Youssef Kibbe", "Muhammad Saqib", "Modar Sabouni", "Ben Philip", "Robin George", "Mayuri Kalita"];
...
export const emails = [
  ...
  "youssef@iboothme.ae",
  "info@iboothme.ae",
  "shubhneet@iboothme.com",
  "info@iboothme.com",
  "ben@iboothme.app",
  "youssef@iboothme.app",
  "rg@studio94.ae",
  "info@iboothme.app",
  "mayuri@iboothme.app",
  "modar@iboothme.com",
...
export const userData = [
  { country: "UAE", vat: 5, currency: "AED" },
  { country: "KSA", vat: 15, currency: "SAR" },
  { country: "QAR", vat: 0, currency: "QAR" },
];

export const userType = ["ADMIN", "USER"];

export const boundData = ["Inbound", "Outbound"];

export const validStatuses = ["DELETED", "NEW", "SUBMITTED", "CONFIRMED", "LOST", "CANCELLED"];

export const userAreas = ["dashboard", "sales", "events", "development", "marketing", "accounts", "users", "international"];
export const superAdmin = ["Ben", "Saqib", "Modar", "Youssef"];

export const invoicesUrl = "https://yyuevjdymcyyjsszdsnv.supabase.co/storage/v1/object/public/";
export const proposalsUrl = "https://ims-x.iboothme.com/proposals/";
export const unsubscribeUrl = "https://ims-x.iboothme.com/unsubscribe/";
export const reportUrl = "https://studio.iboothme.app/analytics/";
export const createPortalEventUrl = "https://studio.iboothme.app/service/remote/confirm-events";
export const basePortalDomain = "https://iboothme.vbth.io/";
export const custCode = "uisQsUie276";
export const apiKey = "ksdf85s7a5dsD_s6ha";
export const appType = "iboothme-x";

export const emptyHTML = "<!DOCTYPE html><html><head><title>iboothme</title><style>body{font-family:Arial,sans-serif;font-size:16px;color:#000000;}</style></head><body></body></html>";

export const signatures = {
  iboothme:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>iboothme team</strong></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 52 94 94 094</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  partybox:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:150px; width:121px;"><img alt="iboothme" height="150" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:150px; max-height:150px; width:121px; max-width:121px;" width="121"></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>PartyBox team</strong></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 52 1792 628</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  ben: '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>Ben Philip</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:14px;">Account Manager</div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 56 361 9078</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  saqib:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>Muhammad Saqib</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:14px;">Sales Manager</div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 55 528 1213</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  shubhneet:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>Shubhneet Jain</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:14px;">Marketing Manager</div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 54 540 5088</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  robin:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>Robin George</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:14px;">Senior Accountant</div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 56 181 0827</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  youssef:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4; font-family:Verdana, Geneva, sans-serif; color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px; width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px; max-height:33px; width:177px; max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-weight:700; font-size:15px;"><strong>Youssef Kibbe</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:14px;">Founder</div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 52 94 94 094</span></div></td></tr><tr><td><div style="font-family:Verdana, Geneva, sans-serif; color:#000; font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>',
  mayuri:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4;font-family:Verdana,Geneva,sans-serif;color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px;width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px;max-height:33px;width:177px;max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-weight:700;font-size:15px;"><strong>Mayuri Kalita</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:14px;">International Account Manager</div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:13px;"><span>+971 52 15 94 297</span></div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:13px;"></div></td></tr></table></td></tr></table></td></tr></table>',
  modar:
    '<table border="0" cellpadding="0" cellspacing="0" width="500"><tr><td><table border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;" valign="top"><table border="0" cellpadding="0" cellspacing="0" style="line-height:1.4;font-family:Verdana,Geneva,sans-serif;color:#000;"><tr><td style="padding-bottom:15px;"><div style="height:33px;width:177px;"><img alt="iboothme" height="33" src="https://websites-cdn.s3.eu-central-1.amazonaws.com/iboothme.ae/signature/logo.png" style="height:33px;max-height:33px;width:177px;max-width:177px;" width="177"></div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-weight:700;font-size:15px;"><strong>Modar</strong></div></td></tr><tr><td style="padding-bottom:15px;"><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:14px;">Sales executive</div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:13px;"><span>+971 58 10 10 383</span></div></td></tr><tr><td><div style="font-family:Verdana,Geneva,sans-serif;color:#000;font-size:13px;"><span>+971 4 44 88 567</span></div></td></tr></table></td></tr></table></td></tr></table>'
};